<template>
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-form-item>
        <el-button type="normal" @click="onSubmit">查询</el-button>
      </el-form-item>
      <el-form-item>
        <el-button type="normal" @click="addvideo">添加视频</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="list"
...
<!--      </el-table-column>-->
      ...
      <el-table-column label="操作" align="center" width="230" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button type="normal" size="mini" @click="editvideo(scope.row.videoId)">
            编辑
          </el-button>
          <el-button type="normal" size="mini" @click="delvideo(scope.row.videoId)">
            下架
          </el-button>
        </template>
      </el-table-column>
